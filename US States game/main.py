...
while game_is_on:
    ...
    if answer_state == "Exit":
        for states in states_data.state:
            if states not in states_done:
                states_not_done.append(states)
...
us_states = {
    "state_status": ["states_done", "states_not_done", "score"],
    "states": [states_done, states_not_done, score]
}

states_of_us = pandas.DataFrame(us_states)
states_of_us.to_csv("us_states.csv")
